...
from mobilevlm.mobilelisa import MobileLISAForCausalLM
...
def parse_args(args):
    ...
    parser.add_argument(
        "--version", default="mtgv/MobileVLM-1.7B"
    )
    ...
    parser.add_argument("--vision_pretrained", default="weights/efficient_sam_vits.pt.zip", type=str)
