...
class MobileLisaMetaModel:
    def __init__(
        ...
        **kwargs,
        ...
        super(MobileLisaMetaModel, self).__init__(config)
...
class MobileLisaModel(MobileLisaMetaModel, MobileLlamaModel):
    def __init__(
        self,
        config,
        **kwargs,
...
class MobileLISAPipeline(nn.Module):
    def __init__(self,
                 version='YouLiXiya/MobileLISA-1.7B',
        ...
        super(MobileLISAPipeline, self).__init__()
        ...
        self.model = MobileLISAForCausalLM.from_pretrained(
